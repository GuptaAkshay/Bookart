var booKart = angular.module("booKart", ["ngRoute", "ngAnimate"]);

booKart.config(function($routeProvider) {
	$routeProvider
		.when("/books", {
...
booKart.factory("kartService", function(){
...
booKart.factory("bookService", function(){
	var books = [
	     		{
...
booKart.controller("KartListCtrl", function($scope, kartService){
...
booKart.controller("HeaderCtrl", function($scope, $location) {
	$scope.appDetails = {};
...
booKart.controller("BookListCtrl", function($scope, bookService, kartService) {
